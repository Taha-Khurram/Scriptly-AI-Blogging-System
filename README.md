...
- **💬 The Studio** — creating a blog is a conversation now. Describe a topic and the agent researches it, proposes an outline and **stops for your approval** before writing a word; then you keep talking: revise sections, change the tone, write another, clear out old drafts. Tool-calling loop, streamed turns that survive a closed tab, two-phase deletes. See [docs/AGENT.md](docs/AGENT.md).
...
| Area | Screens |
|------|---------|
| **Create & draft** | **Studio** (chat agent) · Drafts · Approval Queue · All Blogs |
